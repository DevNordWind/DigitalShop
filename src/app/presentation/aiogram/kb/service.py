...
class ServiceKeyboard:
    ...
    def get_order_items_markups(
        ...
        builder.button(text=self._text("inl-ui.close"), callback_data="service:close")
        return builder.as_markup()

    def get_tech_work_markup(self, support_url: str | None) -> InlineKeyboardMarkup:
        builder = InlineKeyboardBuilder()
        if support_url is not None:
            builder.button(text=self._text("tech-work.support-btn"), url=support_url)
        builder.button(text=self._text("inl-ui.close"), callback_data="service:close")
        return builder.as_markup()
