...
from app.presentation.aiogram.dialog.admin.coupon.ctx import (
    CTX_KEY,
    AdminCouponCtx,
)
from app.presentation.aiogram.state import AdminCouponState
...
async def on_sorting_order(
    ...
    new_order: SortingOrder = (
        SortingOrder.DESC if ctx.sorting.order == SortingOrder.ASC else SortingOrder.ASC
    )
