...
from app.domain.coupon.value_object import CouponCode, CouponValidity
from app.infra.authentication.telegram.dto import TelegramContextDTO
from app.presentation.aiogram.port import Text
from app.presentation.aiogram.state import CreateCouponState
...
async def on_select_type(
    event: CallbackQuery,
    widget: Select[CouponDiscountType],
    dialog_manager: DialogManager,
    tp: CouponDiscountType,
) -> None:
    if tp == CouponDiscountType.FIXED:
