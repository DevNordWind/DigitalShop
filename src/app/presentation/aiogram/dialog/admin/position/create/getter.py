...
from app.app.shopping.category.query import GetCategoryShort, GetCategoryShortQuery
...
async def view_getter(
    ...
    **_: Any,
    ...
    return {
        ...
        "can_confirm": settings.is_default_lang_filled(ctx.name) and ctx.can_confirm,
    }
