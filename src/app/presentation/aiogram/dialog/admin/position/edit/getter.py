...
from app.app.common.dto.file_key import FileKeyMapper as AppFileKeyMapper
...
from app.presentation.aiogram.dialog.admin.position.edit.ctx import (
    CTX_KEY,
...
async def edit_name_getter(
    ...
    **_: Any,
    ...
    return {
        ...
        "can_translate_to_others": ctx.current_name_lang == position.name.default_lang
...
async def edit_price_getter(
    ...
    **_: Any,
    ...
    return {
        ...
        "can_convert_to_others": position.price.base_currency == ctx.current_currency,
