...
from app.presentation.aiogram.state import StockItemState
...
item = Window(
    ...
    SwitchTo(
        ...
        when=F["item_status"] != StockItemStatus.ARCHIVED,
    ),
    Button(GetText("inl-ui.recover"), id="recover", on_click=on_recover_item),  # type: ignore[bad-argument-type]
    SwitchTo(
    ...
    getter=item_getter,  # type: ignore[bad-argument-type]
)
...
filters = Window(
    ...
    Button(
        ...
        id="order",
        on_click=on_filter_order,  # type: ignore[bad-argument-type]
    ),
    Group(
        Select(
...
archive_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.archive"),
        id="delete",
        on_click=on_archive_item,  # type: ignore[bad-argument-type]
        state=StockItemState.item,
...
delete_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.delete"),
        id="delete",
        on_click=on_delete_item,  # type: ignore[bad-argument-type]
        state=StockItemState.items,
        style=Style(ButtonStyle.DANGER),
    ),
    SwitchTo(GetText("inl-ui.back"), id="back", state=StockItemState.item),
...
archive_all_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.archive"),
        id="delete",
        on_click=on_archive_all,  # type: ignore[bad-argument-type]
        state=StockItemState.items,
        style=Style(ButtonStyle.DANGER),
    ),
    SwitchTo(GetText("inl-ui.back"), id="back", state=StockItemState.items),
...
delete_all_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.delete"),
        id="delete",
        on_click=on_delete_all,  # type: ignore[bad-argument-type]
        state=StockItemState.items,
    ),
    SwitchTo(GetText("inl-ui.back"), id="back", state=StockItemState.items),
    state=StockItemState.delete_all_confirmation,
