...
category_filters = Window(
    ...
    Button(
        ...
        id="order",
        on_click=on_category_sorting_order,  # type: ignore[bad-argument-type]
    ),
    Group(
        Select(
...
select_position = Window(
    ...
    Button(GetText("inl-ui.create"), id="create_btn", on_click=on_create),  # type: ignore[bad-argument-type]
    SwitchTo(
        GetText("inl-ui.back"),
        id="back",
        state=AdminPositionState.select_category,
...
position_filters = Window(
    ...
    Button(
        ...
        id="order",
        on_click=on_position_sorting_order,  # type: ignore[bad-argument-type]
    ),
    Group(
        Select(
...
position = Window(
    ...
    Button(
        ...
        id="to_edit_name",
        on_click=on_edit_name,  # type: ignore[bad-argument-type]
        when=~F["is_archived"],
    ),
    Button(
        GetText("admin-position.description-btn"),
        id="to_edit_description",
        on_click=on_edit_description,  # type: ignore[bad-argument-type]
        when=~F["is_archived"],
    ),
    Group(
        Button(
            ...
            id="to_edit_media",
            on_click=on_edit_media,  # type: ignore[bad-argument-type]
            when=~F["is_archived"],
        ),
        Button(
            GetText("admin-position.price-btn"),
            id="to_price_name",
            on_click=on_edit_price,  # type: ignore[bad-argument-type]
            when=~F["is_archived"],
        ),
        width=2,
    ),
    Button(
        ...
        id="to_edit_items",
        on_click=on_edit_item,  # type: ignore[bad-argument-type]
        when=~F["is_archived"],
    ),
    SwitchTo(
    ...
    Button(
        ...
        id="recover",
        when=F["is_archived"],
        on_click=on_recover_position,  # type: ignore[bad-argument-type]
    ),
    SwitchTo(
...
archive_confirmation = Window(
    ...
    Button(
        ...
        on_click=on_archive_position,  # type: ignore[bad-argument-type]
        id="archive",
    ),
    SwitchTo(
        GetText("inl-ui.back"),
...
delete_confirmation = Window(
    ...
    Button(
        GetText("inl-ui.delete"),
        style=Style(ButtonStyle.DANGER),
        on_click=on_delete_position,  # type: ignore[bad-argument-type]
        id="delete",
    ),
    SwitchTo(
        GetText("inl-ui.back"),
...
archive_all_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.archive"),
        style=Style(ButtonStyle.DANGER),
        on_click=on_archive_all_positions,  # type: ignore[bad-argument-type]
        id="archive",
        state=AdminPositionState.select_position,
    ),
    SwitchTo(
...
delete_all_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.delete"),
        style=Style(ButtonStyle.DANGER),
        on_click=on_delete_all_positions,  # type: ignore[bad-argument-type]
        id="delete",
        state=AdminPositionState.select_position,
    ),
    SwitchTo(
