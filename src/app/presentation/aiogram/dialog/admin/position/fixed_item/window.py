...
from app.presentation.aiogram.dialog.admin.position.fixed_item.getter import (
    archive_getter,
    archived_item_getter,
    item_getter,
)
from app.presentation.aiogram.state import FixedItemState
...
archived_item = Window(
    ...
    SwitchTo(
        ...
        id="recover",
        on_click=on_recover_archived_item,  # type: ignore[bad-argument-type]
        state=FixedItemState.item,
    ),
...
delete_confirmation = Window(
    ...
    SwitchTo(
        GetText("inl-ui.delete"),
        on_click=on_delete_archived_item,  # type: ignore[bad-argument-type]
        id="delete",
        state=FixedItemState.item,
        style=Style(ButtonStyle.DANGER),
    ),
