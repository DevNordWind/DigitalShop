...
from app.app.shopping.category.query.get_with_goods_amount import (
...
from app.presentation.aiogram.dialog.admin.category.const import (
    CATEGORIES_PAGE_LIMIT,
    CATEGORIES_SCROLL,
)
from app.presentation.aiogram.dialog.admin.category.ctx import (
    CTX_KEY,
    AdminCategoryCtx,
)
...
async def categories_getter(
    ...
    **_: Any,
    ...
    return {
        "pages": (paginated.total + CATEGORIES_PAGE_LIMIT - 1) // CATEGORIES_PAGE_LIMIT,
        "buttons": [
            CategoryButton(
                id=category.id,
