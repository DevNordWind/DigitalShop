...
from app.app.shopping.category.query import GetCategory, GetCategoryQuery
...
from app.presentation.aiogram.dialog.admin.category.edit.ctx import (
    CTX_KEY,
    CategoryEditingCtx,
)
...
async def edit_name_getter(
    ...
    **_: Any,
    ...
    return {
        ...
        "can_translate_to_others": dto.name.default_lang == ctx.current_name_lang
