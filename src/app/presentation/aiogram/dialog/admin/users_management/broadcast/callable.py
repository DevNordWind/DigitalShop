...
from app.presentation.aiogram.dialog.admin.users_management.broadcast.ctx import (
    CTX_KEY,
    BroadcastCtx,
    BroadcastSetup,
)
from app.presentation.aiogram.port import Text
from app.presentation.aiogram.port.broadcast import (
    BroadcastMedia,
    BroadcastRequest,
    TelegramBroadcaster,
)
from app.presentation.aiogram.port.broadcast.dto import (
...
from app.presentation.aiogram.port.broadcast.exception import (
    BroadcastTextsAsymmetricallyError,
)
from app.presentation.aiogram.state import BroadcastState
...
async def on_select_preview_lang(
    ...
    ctx: BroadcastCtx = retort.load(dialog_manager.dialog_data[CTX_KEY], BroadcastCtx)
...
async def on_start_broadcast(
    ...
    except BroadcastTextsAsymmetricallyError as e:
        return await event.answer(text=t(e.__class__.__name__))
