...
from app.presentation.aiogram.dialog.admin.users_management.broadcast.getter import (
    broadcast_getter,
    buttons_getter,
    input_media_getter,
    input_texts_getter,
...
broadcast = Window(
    ...
    Button(
        ...
        id="start",
        when=F["can_start"],
        on_click=on_start_broadcast,  # type: ignore[bad-argument-type]
    ),
...
input_media = Window(
    ...
    MessageInput(
        ...
        id="input_media",
        func=on_input_media,  # type: ignore[bad-argument-type]
    ),
    SwitchTo(GetText("inl-ui.back"), id="back", state=BroadcastState.broadcast),
    state=BroadcastState.input_media,
...
buttons = Window(
    ...
    Group(
        ListGroup(
            ...
            Button(Const("🗑"), id="delete", on_click=on_delete_url_button),  # type: ignore[bad-argument-type]
    ...
    Button(
        ...
        on_click=on_switch_close_button,  # type: ignore[bad-argument-type]
    ),
    Start(
