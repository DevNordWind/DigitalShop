...
async def on_input_name(
    ...
    ctx: UrlButtonCtx = retort.load(dialog_manager.dialog_data[CTX_KEY], UrlButtonCtx)
...
async def on_input_url_error(
    ...
    return await event.reply(text=text("admin-broadcast-buttons-url-url.invalid"))
