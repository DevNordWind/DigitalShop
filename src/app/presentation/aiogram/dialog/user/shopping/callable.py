...
from app.presentation.aiogram.dialog.user.shopping.ctx import CTX_KEY, ShoppingCtx
from app.presentation.aiogram.state import OrderState, ShoppingState
...
async def on_buy(
    ...
    if ctx.current_position_warehouse_type is None or ctx.current_position_id is None:
        return None
