...
from app.app.wallet.query import GetWalletsByUserIdWithTotal
from app.app.wallet.query.get_by_user_id_with_total import (
    GetWalletsByUserIdWithTotalQuery,
    WalletsWithTotal,
)
from app.domain.common.money import Currency
from app.infra.authentication.telegram.dto import TelegramContextDTO
from app.presentation.aiogram.dialog.user.wallet.ctx import CTX_KEY, WalletCtx
...
async def wallet_getter(
    ...
    query_handler: FromDishka[GetWalletsByUserIdWithTotal],
...
async def change_wallet_getter(
    ...
    **_: Any,
    ...
    return {
        "buttons": [
            CurrencyButton(currency=currency, is_current=currency == tg_ctx.currency)
