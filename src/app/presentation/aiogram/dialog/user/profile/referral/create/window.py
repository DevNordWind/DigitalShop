...
from app.presentation.aiogram.dialog.user.profile.referral.create.callable import (
    on_select_currency,
)
from app.presentation.aiogram.dialog.user.profile.referral.create.getter import (
    select_currency_getter,
)
from app.presentation.aiogram.state import CreateReferrerProfileState
