...
from app.infra.presentation.aiogram import MessageNotContainFileError
from app.infra.presentation.aiogram.mapper import UnsupportedContentTypeError
    ...
    def _extract_tg_file(cls, msg: Message) -> TelegramFile:
        ...
        match msg.content_type:
            ...
            case ContentType.VIDEO:
                file = msg.video
            case _:
                raise UnsupportedContentTypeError(type=ContentType(msg.content_type))

        if file is None:
            raise MessageNotContainFileError
