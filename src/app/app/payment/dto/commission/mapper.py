from app.app.common.dto.coefficient.mapper import CoefficientMapper
from app.app.common.dto.money import MoneyMapper
from app.app.payment.dto.commission.dto import CommissionDTO, CommissionSnapshotDTO
from app.domain.payment.rule import (
    CustomerCommissionRule,
    PaymentCommissionRule,
    ShopCommissionRule,
)
from app.domain.payment.value_object import CommissionSnapshot
...
class CommissionMapper:
    ...
    def to_dto(cls, src: PaymentCommissionRule) -> CommissionDTO:
        match src:
            ...
            case _:
                raise ValueError(
                    f"Unknown PaymentCommissionRule type: {src.__class__.__name__}",
                )
