...
from app.infra.presentation.aiogram.broadcast.dto import BroadcastProgress
from app.infra.presentation.aiogram.broadcast.kb_builder import BroadcastKeyboardBuilder
...
class BroadcastProgressMessage:
    ...
    async def start(self, reporting: BroadcastReporting, total: int) -> Message:
