...
from app.infra.presentation.aiogram.mapper.file.exception import (
    InvalidMediaAttachmentError,
    MessageNotContainFileError,
    TelegramFileDownloadError,
    UnsupportedContentTypeError,
)
from app.infra.presentation.aiogram.mapper.file.mapper import FileTypeMapper
    ...
    def _extract_tg_file(self, msg: Message) -> TelegramFile:
        ...
        match msg.content_type:
            ...
            case ContentType.DOCUMENT:
                file = msg.document
            case _:
                raise UnsupportedContentTypeError(ContentType(msg.content_type))
