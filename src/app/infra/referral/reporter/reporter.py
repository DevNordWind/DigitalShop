...
class SqlAReferralSystemReporter(ReferralSystemReporter):
    ...
    async def get_referrer_report(
        ...
        user_filters = [user_table.c.referrer_id == referrer_id]
        award_filters = [
            referral_award_table.c.referrer_id == referrer_id,
