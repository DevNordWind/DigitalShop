...
from app.app.order.dto.applied_coupon import AppliedCouponDTO
from app.app.order.dto.order import OrderDTO
from app.app.order.dto.source import PaymentSourceDTO
from app.app.shopping.position.dto.snapshot import (
    ItemSnapshotMapper,
    PositionSnapshotMapper,
)
...
class OrderReaderMapper:
    ...
    def _map_applied_coupon(cls, row: Any) -> AppliedCouponDTO | None:
        ...
        return AppliedCouponDTO(
            coupon_id=row.applied_coupon_id.value,
            discount=MoneyDTO(
