...
class RemoveCategoryDescriptionCmd:
    id: UUID
    lang: Language


class RemoveCategoryDescription:
    def __init__(
        self,
    ...
    async def __call__(self, cmd: RemoveCategoryDescriptionCmd) -> None:
        ...
        category.remove_description(lang=cmd.lang, now=self._clock.now())
