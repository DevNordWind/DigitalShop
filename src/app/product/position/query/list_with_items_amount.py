...
class ListPositionsWithItemsAmountByCategoryQuery:
    category_id: UUID
...
class ListPositionsWithItemsAmountByCategory:
    ...
    async def __call__(
        self,
        query: ListPositionsWithItemsAmountByCategoryQuery,
    ) -> PositionWithItemsAmountPaginated:
        ...
        return await self._reader.read_with_items_amount_by_category_id(
