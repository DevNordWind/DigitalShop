...
class ChangePositionDescriptionDefaultLangCmd:
    id: UUID
    lang: Language


class ChangePositionDescriptionDefaultLang:
    def __init__(
        self,
    ...
    async def __call__(
        self,
        cmd: ChangePositionDescriptionDefaultLangCmd,
    ) -> None:
        ...
        position.change_description_default_lang(
            lang=cmd.lang,
            now=self._clock.now(),
        )
