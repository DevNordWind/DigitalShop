...
class RemovePositionNameCmd:
    id: UUID
    lang: Language


class RemovePositionName:
    def __init__(
        self,
    ...
    async def __call__(self, cmd: RemovePositionNameCmd) -> None:
        ...
        position.remove_name(lang=cmd.lang, now=self._clock.now())
