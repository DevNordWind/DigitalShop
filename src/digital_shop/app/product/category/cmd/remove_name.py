...
class RemoveCategoryNameCmd:
    id: UUID
    lang: Language


class RemoveCategoryName:
    def __init__(
        self,
    ...
    async def __call__(self, cmd: RemoveCategoryNameCmd) -> None:
        ...
        category.remove_name(lang=cmd.lang, now=self._clock.now())
