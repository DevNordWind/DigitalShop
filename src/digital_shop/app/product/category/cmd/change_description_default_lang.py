...
class ChangeCategoryDescriptionDefaultLangCmd:
    id: UUID
    lang: Language


class ChangeCategoryDescriptionDefaultLang:
    def __init__(
        self,
    ...
    async def __call__(
        self,
        cmd: ChangeCategoryDescriptionDefaultLangCmd,
    ) -> None:
        ...
        category.change_description_default_lang(
            lang=cmd.lang,
            now=self._clock.now(),
        )
